<?php
$tbl = $pdo->query('SELECT * FROM `sprzedawcy`');

echo '<br><a href="admin/sellers/add.php" class="btn btn-success" role="button">dodaj sprzedawcę</a><br>'
...
foreach ($tbl->fetchAll() as $value) {
    ...
    . '<th>' . $value['Miasto'] . '</th>'
    . '<th>' . $value['NIP'] . '</th>'
    . '<th><a href="admin/sellers/usun.php?id=' . $value['ID'] .
    '" class="btn btn-danger" role="button" >Usuń</a>'
    . '<a href="admin/sellers/add.php?id='
